...
const About = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-32 md:py-40 overflow-hidden" style={{ background: 'linear-gradient(135deg, #8e1c1c 0%, #8e1c1c 50%, #8e1c1c 100%)' }}>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div
                ...
                style={{ background: 'linear-gradient(135deg, #8e1c1c 0%, #8e1c1c 100%)' }}
              >
                <motion.div
              ...
              >
                ...
                >
                  <div className="w-32 h-32 mx-auto mb-6 rounded-full flex items-center justify-center bg-gradient-to-br from-red-100 to-red-50 shadow-lg">
                    <div className="text-5xl font-bold" style={{ color: "#8e1c1c" }}>{item.step}</div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="text-3xl" style={{ color: "#8e1c1c" }}>{item.icon}</div>
                </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <span className="font-semibold text-sm uppercase tracking-wider mb-4 block" style={{ color: "#8e1c1c" }}>
              Our Direction
            </span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
              Vision & Mission
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative">
                <div className="w-20 h-20 bg-red-100 rounded-2xl flex items-center justify-center mb-6">
                  <FaEye className="text-4xl" style={{ color: "#8e1c1c" }} />
                </div>
            ...
            >
              ...
              <div className="relative">
                <div className="w-20 h-20 bg-red-100 rounded-2xl flex items-center justify-center mb-6">
                  <FaBullseye className="text-4xl" style={{ color: "#8e1c1c" }}/>
                </div>
      ...
      {/* CTA Section */}
      <section className="py-24 text-white relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #8e1c1c 0%, #8e1c1c 100%)' }}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="flex flex-wrap justify-center gap-4"
            >
              <a href="/contact" className="bg-white px-10 py-5 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all duration-300 shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 inline-flex items-center gap-2" style={{color : "#8e1c1c"}}>
